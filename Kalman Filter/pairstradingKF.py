...
def fetch_data(ticker_1, ticker_2, start_date='2020-01-01', end_date='2024-01-01'):
    data_1 = yf.download(ticker_1, start=start_date, end=end_date)['Close']
    data_2 = yf.download(ticker_2, start=start_date, end=end_date)['Close']
...
def kalman_filter_spread(series_1, series_2):
    ...
    x = np.array([0, 0])  # Starting with zero spread and zero velocity
...
pairs_trading("MSFT", "AAPL", start_date="2020-01-01", end_date="2024-01-01")
